#!/bin/bash
# mout elastic file system to ec2
sudo yum update -y
...
# install apache, php, linux and configuring permission
...
# copy content from clixx repository into/var/www/html
...
# change ownership of apache and restart services
